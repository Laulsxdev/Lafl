...
/* The one sidebar body, rendered twice: inline on `lg`, inside the mobile drawer below it. */
function SidebarPanel({
  ...
  return (
    <>
      ...
      {/* User + sign out */}
      <div className="border-t border-neutral-100 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
...
export default async function AppLayout({
  ...
  return (
    <div className="min-h-dvh bg-neutral-50 lg:flex">
      <MobileNav orgLabel={orgLabel}>{panel}</MobileNav>
